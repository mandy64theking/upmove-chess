...
export default function CustomNavBar() {
  ...
  return (
    <div
      ...
      } justify-between p-8 m-5 border-2 border-gray shadow-lg rounded-3xl`}
    >
      <div className="flex flex-row justify-between w-full items-center">
        <Image
          ...
          height={100}
          src="/logo.png"
          alt="Upmove Chess Academy"
          className="dark:invert max-h-[10vh] min-h-10 min-w-1.5 bg-white rounded-md"
        />
        <ul
