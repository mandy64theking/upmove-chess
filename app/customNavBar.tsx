...
export default function CustomNavBar() {
  ...
  const handleMenuClick = () => {
    ...
    return(
    <div className={`fixed top-0 left-0 sm:w-[95vw] w-[90vw] bg-background dark:bg-black opacity-90 dark:opacity-100 flex ${menuOpen ? 'flex-col h-[48vh] z-10 opacity-100':'flex-row h-[15vh] z-10'} justify-between p-8 m-5 border-2 border-gray rounded-3xl`}>
              ...
              <div className={`${menuOpen ? 'hidden' : ''}`}><TooltipProvider>
                <Tooltip>
