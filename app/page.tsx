          ...
          <div className="grid mb-5 sm:grid-cols-2 gap-5">
            <Card className="mt-5 w-[80vw] sm:w-[40vw] dark:bg-muted transition-all hover-scale">
              <CardHeader>
                ...
                <CardDescription>
                  Whether you&apos;re a child, a student, or an adult, chess is
                  a lifelong journey of learning and enjoyment. It&apos;s never
      ...
      <div className="min-h-[90vh] w-full flex flex-col sm:flex-row justify-center items-center">
        <div className="pt-[15vh]">
          ...
          <h1 className="text-foreground bg-background font-normal text-center mt-10 max-w-[80vw] sm:max-w-[80vw]">
            ...
            you&apos;re a beginner or a seasoned player, we have the expertise
